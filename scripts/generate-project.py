...
resources = add('resources', '{isa = PBXResourcesBuildPhase; buildActionMask = 2147483647; files = ' + array([license_build]) + '; runOnlyForDeploymentPostprocessing = 0; }')
main = add('main', '{isa = PBXGroup; children = ' + array([sources, info, license_ref, products]) + '; sourceTree = "<group>"; }')
